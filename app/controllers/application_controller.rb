class ApplicationController < ActionController::Base
  ...
  # before_action :set_current_group, if: :user_signed_in?
  ...
  #   @current_group = current_user.keep_group_id ? Group.find(current_user.keep_group_id) : Group.first
  # end
  #
  # def init_group
  #   if current_user.groups.blank?
  #     current_user.groups.create!(name: "グループ", owner_id: current_user.id)
